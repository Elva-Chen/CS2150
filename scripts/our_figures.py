...
T = ['TreeSwift_Newick', 'TreeSwift_NeXML', 'TreeSwift_Nexus']
name_to_key = {'TreeSwift_Newick':'treeswift_newick', 'TreeSwift_NeXML':'treeswift_nexml', 'TreeSwift_Nexus':'treeswift_nexus'}
pal = {'TreeSwift_Newick':'black', 'TreeSwift_NeXML':'red', 'TreeSwift_Nexus':'blue'}
linestyle = {'TreeSwift_Newick':'-', 'TreeSwift_NeXML':':', 'TreeSwift_Nexus':'--'}
meta = {
    'name': {
